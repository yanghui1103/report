...
function getPerformanceValue(parentEleObj,value)
{
	var radioObjs = document.getElementsByName('performanceRadio');
	if (radioObjs) 
	{
...
function setPerformanceValue(parentEleObj,newvalue)
{
	var radioObjs = document.getElementsByName('performanceRadio');
	if (radioObjs) 
	{
...
function getDescriptionValue(parentEleObj,value)
{
	return document.getElementById('report1description').value;
}

function setDescriptionValue(parentEleObj,newvalue)
{
	document.getElementById('report1description').value=newvalue;
}

function getTxtname(parentEleObj,value)
{
	return document.getElementById('txtname_id').value;
}

function setTxtname(parentEleObj,newvalue)
{
	document.getElementById('txtname_id').value=newvalue;
}

function getTxtage(parentEleObj,value)
{
	return document.getElementById('txtage_id').value;
}

function setTxtage(parentEleObj,newvalue)
{
	document.getElementById('txtage_id').value=newvalue;
}