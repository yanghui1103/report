...
public class Interceptor_customizedchartpage1_report1 extends AbsInterceptorDefaultAdapter
{
    ...
    public void beforeDisplayReportData(ReportRequest rrequest,ReportBean rbean,ReportDataBean reportDataBean)
    {
        ...
        chartDataBuf.append("</dataset>");
        chartDataBuf.append("<dataset>");
        chartDataBuf.append("<dataset seriesname='Service A' color='8BBA00' showValues='0'>");
        chartDataBuf.append("<set value='27' />");
        chartDataBuf.append("<set value='25' />");
        chartDataBuf.append("<set value='28' />");
        chartDataBuf.append("<set value='26' />");
        chartDataBuf.append("<set value='10' />");
        chartDataBuf.append("</dataset>");
        chartDataBuf.append("<dataset seriesname='Service B' color='A66EDD' showValues='0'>");
        chartDataBuf.append("<set value='17' />");
        chartDataBuf.append("<set value='15' />");
        chartDataBuf.append("<set value='18' />");
        chartDataBuf.append("<set value='16' />");
        chartDataBuf.append("<set value='10' />");
        chartDataBuf.append("</dataset>");
        chartDataBuf.append("<dataset seriesname='Service C' color='F984A1' showValues='0'>");
        chartDataBuf.append("<set value='12' />");
        chartDataBuf.append("<set value='17' />");
        chartDataBuf.append("<set value='16' />");
        chartDataBuf.append("<set value='15' />");
        chartDataBuf.append("<set value='12' />");
        chartDataBuf.append("</dataset>");
        chartDataBuf.append("</dataset>");
        chartDataBuf.append("<lineset seriesname='Cost as % of Revenue' showValues='0' lineThickness='4'>");
        chartDataBuf.append("<set value='57' />");
        chartDataBuf.append("<set value='68' />");
        chartDataBuf.append("<set value='79' />");
        chartDataBuf.append("<set value='73' />");
        chartDataBuf.append("<set value='80' />");
        chartDataBuf.append("</lineset>");
